...
@Mod(modid = "cheatbreaker", version = Wurstplus.WURSTPLUS_VERSION, name = Wurstplus.WURSTPLUS_NAME)
public class Wurstplus {
	...
	public static final String WURSTPLUS_VERSION = "b7";
	public static final String WURSTPLUS_SIGN = " ";

	public static final int WURSTPLUS_KEY_GUI = Keyboard.KEY_Y;
	...
	public void WurstplusStarting(FMLInitializationEvent event) {
		...
		Display.setTitle(Wurstplus.WURSTPLUS_NAME + " " + Wurstplus.WURSTPLUS_VERSION);
