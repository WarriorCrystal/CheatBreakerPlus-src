...
public class WurstplusUser extends WurstplusPinnable {
	...
	public void render() {
		...
		if (time >= 0 && time < 12) {
			line = "Good Morning, " + ChatFormatting.RED + ChatFormatting.BOLD + mc.player.getName();
		} else if (time >= 12 && time < 16) {
			line = "Good Afternoon, " + ChatFormatting.RED + ChatFormatting.BOLD +  mc.player.getName();
		} else if (time >= 16 && time < 24) {
			line = "Good Evening, " + ChatFormatting.RED + ChatFormatting.BOLD +  mc.player.getName();
		} else {
